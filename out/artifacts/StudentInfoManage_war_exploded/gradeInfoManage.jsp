...
<head>
    ...
    <script type="text/javascript">
        ...
        function deleteGrade(){
            ...
            var ids=strIds.join(",");
            $.messager.confirm("系统提示","你是不是要删这<font color=red>"+selectedRows.length+"</font>条数据",function(r){
                if(r){
                    $.post("gradeDelete",{delIds:ids},function(result){
                        if(result.success){
                            $.messager.alert("系统提示","你已经删除<font color=red>"+result.delNums+"</font>条数据！");
                            $("#dg").datagrid("reload");
                        }else{
...
<table id="dg" title="班级信息" class="easyui-datagrid" fitColumns="true"
    ...
    <tr>
        ...
        <th field="gradeDesc" width="250">班级备注</th>
    </tr>
    </thead>
</table>
